...
<div class="col-lg-10 mt-2 mx-auto mt-3">
    <div class="card">
        ...
        <div class="card-body">
            <a href="order" class="btn btn-info mb-3">kembali</a>
            <div class="row">
                <div class="col-lg-3">
            ...
            <div>
                <button
                    ...
                    data-bs-toggle="modal" data-bs-target="#tambahItem"><i class="bi bi-patch-plus-fill"></i>
                    Item</button>
                <button
                    class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary disabled" : "btn btn-primary"; ?>"
                    data-bs-toggle="modal" data-bs-target="#bayar"><i class="bi bi-currency-dollar"></i> Bayar</button>
